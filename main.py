...
def draw_hud(surface):
    hw, hx, hy = 340, 10, 10
    hh = 148 + 34  # extra 34px for NHPP strip
    ...
    lbl_surf = font_telemetry.render(
        f"λ(t)  {phase_lbl}  ×{cur_mult:.2f}", True, lbl_col)
...
while running:
    ...
    if GAME_STATE == "RUNNING" and player:
        ...
        round_manager.tick_session()  # advance NHPP session clock
