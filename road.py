...
class Road:
    ...
    def _bake_compound(self):
        """Small IUT grass compound below the wall."""
    ...
    def _draw_trees(self, screen):
        # Skip procedural trees if the pixel art gate (which has trees) is loaded
        if self.gate_img:
            return
